...
export const LEVEL_CONFIGS: Record<number, LevelConfig> = {
  ...
  13: {
    ...
    ringScale: 0.3,
    rings: [
      { id: 'ring1', position: { x: -120, y: 0 }, angle: 180 },
      { id: 'ring2', position: { x: 0, y: 0 }, angle: 0 },
      { id: 'ring3', position: { x: 120, y: 0 }, angle: 180 },
      { id: 'ring4', position: { x: -123, y: -120 }, angle: -90 },
      { id: 'ring5', position: { x: 120, y: 120 }, angle: -270 },
      { id: 'ring6', position: { x: -119, y: 120 }, angle: 0 },
      { id: 'ring7', position: { x: -240, y: -240 }, angle: -90 },
      { id: 'ring8', position: { x: -240, y: -120 }, angle: 90 },
      { id: 'ring9', position: { x: -240, y: 0 }, angle: 90 },
      { id: 'ring10', position: { x: -240, y: 120 }, angle: 90 },
      { id: 'ring11', position: { x: -240, y: 240 }, angle: 0 },
      { id: 'ring12', position: { x: 120, y: -120 }, angle: 0 },
      { id: 'ring13', position: { x: 240, y: -240 }, angle: -180 },
      { id: 'ring14', position: { x: 240, y: -120 }, angle: -90 },
      { id: 'ring16', position: { x: 240, y: 120 }, angle: -90 },
      { id: 'ring18', position: { x: 240, y: 240 }, angle: 90 },
      { id: 'ring17', position: { x: 240, y: 0 }, angle: -90 },
    ],
    buckles: [
      { ringId: 'ring2', angle: 90, linkedRingId: 'ring3' },
      { ringId: 'ring2', angle: -90, linkedRingId: 'ring1' },
      { ringId: 'ring4', angle: 0, linkedRingId: 'ring8' },
      { ringId: 'ring5', angle: 0, linkedRingId: 'ring16' },
      { ringId: 'ring7', angle: -90, linkedRingId: 'ring8' },
      { ringId: 'ring9', angle: 0, linkedRingId: 'ring1' },
      { ringId: 'ring9', angle: -90, linkedRingId: 'ring8' },
      { ringId: 'ring10', angle: 0, linkedRingId: 'ring6' },
      { ringId: 'ring10', angle: 90, linkedRingId: 'ring11' },
      { ringId: 'ring10', angle: -90, linkedRingId: 'ring9' },
      { ringId: 'ring14', angle: 0, linkedRingId: 'ring12' },
      { ringId: 'ring14', angle: -90, linkedRingId: 'ring17' },
      { ringId: 'ring14', angle: 90, linkedRingId: 'ring13' },
      { ringId: 'ring18', angle: -90, linkedRingId: 'ring16' },
      { ringId: 'ring17', angle: 0, linkedRingId: 'ring3' },
      { ringId: 'ring17', angle: -90, linkedRingId: 'ring16' },
    ],
    rocks: [],
    bombs: [],
  },
