...
export const LEVEL_CONFIGS: Record<number, LevelConfig> = {
  ...
  8: {
    ...
    buckles: [
      ...
      { id: 'buckle1', ringId: 'ring3', angle: -90, linkedRingId: 'ring4' },
      { id: 'buckle1', ringId: 'ring4', angle: -90, linkedRingId: 'ring5' },
      { id: 'buckle1', ringId: 'ring5', angle: -90, linkedRingId: 'ring6' },
      { id: 'buckle1', ringId: 'ring6', angle: -90, linkedRingId: 'ring7' },
      { id: 'buckle2', ringId: 'ring7', angle: -45, linkedRingId: 'ring8' },
    ],
    rocks: [],
    bombs: [],
  },
  9: {
    ...
    buckles: [
      { id: 'buckle3', ringId: 'ring1', angle: 0, linkedRingId: 'ring8' },
      { id: 'buckle5', ringId: 'ring1', angle: 90, linkedRingId: 'ring13' },
      { id: 'buckle5', ringId: 'ring2', angle: 90, linkedRingId: 'ring5' },
      { id: 'buckle1', ringId: 'ring3', angle: -90, linkedRingId: 'ring2' },
      { id: 'buckle5', ringId: 'ring3', angle: 90, linkedRingId: 'ring9' },
      { id: 'buckle4', ringId: 'ring4', angle: 45, linkedRingId: 'ring6' },
      { id: 'buckle1', ringId: 'ring10', angle: -90, linkedRingId: 'ring1' },
      { id: 'buckle3', ringId: 'ring11', angle: 0, linkedRingId: 'ring5' },
      { id: 'buckle5', ringId: 'ring12', angle: 90, linkedRingId: 'ring5' },
      { id: 'buckle3', ringId: 'ring12', angle: 0, linkedRingId: 'ring4' },
      { id: 'buckle3', ringId: 'ring13', angle: 0, linkedRingId: 'ring3' },
    ],
    rocks: [],
    bombs: [],
  },
